...
\* Supports recording and podcast-production workflows

\* Includes tools for editing recorded material

\* Keeps the experience local-first wherever practical
...
Takesmith is under active development and testing.
